![Knowrag logo](/docs/knowrag-svg.svg "Text to show on mouseover")

# Knowrag - your personal chabot
**KnowRAG** is a **local-first**, privacy-focused RAG (Retrieval-Augmented Generation) framework that lets you chat naturally with your own documents: Obsidian vaults, personal notes, office docs, PDFs, etc.
...
![New chat screen](/docs/knowrag-screen.png)
